...
# AGGIUNTO DA NOI
   ...
   # declared_arguments.append(DeclareLaunchArgument('gz_args', default_value='-r -v 1 empty.sdf',
    ...
    # declared_arguments.append(DeclareLaunchArgument('gz_args', default_value='-r -v 1 /home/user/ros2_ws/install/iiwa_description/share/iiwa_description/gazebo/worlds/empty.world',
    #                           description='Arguments for gz_sim'),)    
